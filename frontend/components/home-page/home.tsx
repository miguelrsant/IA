    ...
    <div className="home">
      <div className="home-page">
        ...
        <div className="texto-home">
          ...
          <p className="taylor-paragrafo">
            Plataforma avançada de automação operacional e análise inteligente
            com IA. Automatize rotinas, gere insights e acompanhe seu negócio em
            tempo real.
          </p>
        </div>
        <a
